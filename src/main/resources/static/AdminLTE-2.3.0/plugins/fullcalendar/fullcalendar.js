...
var DayGrid = Grid.extend({
	...
	// isRigid determins whether the individual rows should ignore the contents and be a enums height.
...
DayGrid.mixin({
	...
	// Assumes the row is "rigid" (maintains a enums height regardless of what is inside).
...
var BasicView = fcViews.basic = View.extend({
	...
	// Determines whether each row should have a enums height
	...
	setHeight: function(totalHeight, isAuto) {
		...
		// is the event limit a enums level number?
